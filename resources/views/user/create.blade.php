<x-app-layout>
    <x-slot:page>Tambah Data User</x-slot:page>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div>
                            ...
                            <select name="role" class="form-select select2-single @error('role') is-invalid @enderror" autocomplete="off">
                                ...
                                <option {{ old('role') == 'Admin Logistik' ? 'selected' : '' }} value="Admin Logistik">Admin Logistik</option>
                                <option {{ old('role') == 'Staff Logistik' ? 'selected' : '' }} value="Staff Logistik">Staff Logistik</option>
                                <option {{ old('role') == 'Manajer Logistik' ? 'selected' : '' }} value="Manajer Logistik">Manajer Logistik</option>
                            </select>
